...
namespace Uri{
    ...
    */
    ...
    public:
        ...
        PercentEncodedCharacterDecoder(const PercentEncodedCharacterDecoder&) = delete; // Copy Constructor that creates a new object by making a copy of an existing object. 
        //It ensures that a deep copy is performed if the object contains dynamically allocated resources 
        PercentEncodedCharacterDecoder(PercentEncodedCharacterDecoder&&); // Move Constructor that transfers resources from an expiring object to a newly constructed object.
        PercentEncodedCharacterDecoder& operator=(const PercentEncodedCharacterDecoder&) = delete; //Copy Assignment Operation That assigns the values of one object to another object using the assignment operator (=)
        PercentEncodedCharacterDecoder& operator=(PercentEncodedCharacterDecoder&&); //Move Assignment Operator: Amove assignment operator efficiently transfers resources from one object to another.
            //Methods   
        public:
